 ...
 */
package com.dajaca.goodbye.servlet;
...
public class GoodbyeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if( !message.isEmpty() && !message.equals("") ){
                out.println("<h2 class=\"text-red\">Hello Message Received: </h2><p class=\"mb-4\">"+message+"</p>");
            }
    ...
    protected String getHTMLReply(){
        return("<form action=\"/hello-servlet/hello\" class=\"p-5\" method=\"GET\">\n" +
"                          <div class=\"col-12 text-center\">\n" +
"                                <h2 class=\"section-title mb-3\">Send Goodbye Message</h2>\n" +
"                          </div>"+
"                          <div class=\"row form-group\">\n" +
"                                <div class=\"col-md-12\">\n" +
"                                  <!--<label class=\"text-red\" for=\"message\">Message</label>-->\n" +
